...
public class Planner {
	...
	/*未使用
 private boolean contain(ArrayList<String> list, String name) {
	for(int i = 0; i < list.size(); ++i){
		StringTokenizer st1 = new StringTokenizer(name);
		int size = st1.countTokens();
		StringTokenizer st2 = new StringTokenizer(list.get(i));
		if(size == st2.countTokens()){
  ...
  goalList.add("clear A");*/
	...
	private boolean opCheck(Operator op,ArrayList<String> theCurrentState){
		String[] capital = new String[]{"A","B","C","D","E","F","G"};
